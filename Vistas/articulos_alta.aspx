...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <section class="registro">
        ...
        <div class="listaPelis">
            ...
            <asp:GridView ID="grdArticulos" class="grid" runat="server" AllowPaging="True" OnPageIndexChanging="grdArticulos_PageIndexChanging" PageSize="8" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateColumns="False" OnRowDeleting="grdArticulos_RowDeleting" OnRowCancelingEdit="grdArticulos_RowCancelingEdit" OnRowEditing="grdArticulos_RowEditing" OnRowUpdating="grdArticulos_RowUpdating" >
