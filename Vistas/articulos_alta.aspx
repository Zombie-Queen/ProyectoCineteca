...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <section class="registro">
        ...
        <div class="listaPelis">
            <asp:GridView ID="grdArticulos" class="grid" runat="server" AllowPaging="True" OnPageIndexChanging="grdArticulos_PageIndexChanging" PageSize="8" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True"></asp:GridView>
            </div>
