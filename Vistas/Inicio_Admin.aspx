    ...
    <div class="principal">
            ...
            <asp:ListView ID="lvClientesActivos" runat="server" DataSourceID="dsClientes">               
                ...
                <ItemTemplate>                  
                        <div class="Cli">
                         ...
                         <div class="labels"><asp:Label ID="EstadoLabel" runat="server" Text='<%# Eval("Estado") %>' /> </div>
                         <div class="labels"> <asp:Label ID="TotalLabel" runat="server" Text='<%# Eval("Total") %>' /> </div>
        ...
        <div class="promo">
            ...
            <asp:ListView ID="lvPromo" runat="server" DataSourceID="dsPromoDelMes">               
                <ItemTemplate>                  
                    <div class="labels" id="promo"><asp:Label ID="promoMes" runat="server" Text='<%# Eval("[Promoción]") %>' /> </div>                  
                </ItemTemplate>
                <LayoutTemplate>
                    <div id="itemPlaceholderContainer" runat="server" class="item-temp">
                        <span runat="server" id="itemPlaceholder" />
