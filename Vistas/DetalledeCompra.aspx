...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" runat="server">
	...
	<asp:GridView ID="gvAsientos" runat="server" AutoGenerateDeleteButton="True" CssClass="gridas">
				</asp:GridView>
	<asp:DropDownList ID="ddlAsiento0" runat="server" CssClass="ddla" AutoPostBack="True">
                        <asp:ListItem>--Seleccione un asiento</asp:ListItem>
			</asp:DropDownList>
	<br />
	<h1>Promociones</h1>
