...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" runat="server">
    ...
    <p> 
			...
			<table class="w-100">
				<tr>
					<td >Seleccione su/s asiento/s: </td>
	...
	<asp:GridView ID="gvAsientos" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" CssClass="grid" DataSourceID="SqlDataSourceAsientosReservados">
					<Columns>
						<asp:BoundField HeaderStyle-CssClass="header-gv" ItemStyle-CssClass="item-gv" DataField="ID_Asiento_FSA" HeaderText="ID_Asiento_FSA" SortExpression="ID_Asiento_FSA" >
						</asp:BoundField>
						</Columns>
				</asp:GridView>
	<br />
...
<td runat="server" />
	...
	<h4>Articulos seleccionados:</h4>
				<asp:GridView ID="gvArticulos" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" CssClass="grid" DataSourceID="SqlDataSourceArticulosSeleccionados">
					<Columns>
						<asp:BoundField HeaderStyle-CssClass="header-gv" ItemStyle-CssClass="item-gv" DataField="Nombre_Articulo" HeaderText="Articulo" SortExpression="Nombre_Articulo" >
						</asp:BoundField>
						<asp:BoundField HeaderStyle-CssClass="header-gv" ItemStyle-CssClass="item-gv" DataField="Descripción_Articulo" HeaderText="Descripción" SortExpression="Descripción_Articulo" >
						</asp:BoundField>
